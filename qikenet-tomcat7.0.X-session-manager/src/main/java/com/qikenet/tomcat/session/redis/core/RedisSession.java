package com.qikenet.tomcat.session.redis.core;
...
import com.qikenet.tomcat.session.redis.RedisSessionManager;

public class RedisSession extends StandardSession {

	private static final long serialVersionUID = -8006284978017704230L;
